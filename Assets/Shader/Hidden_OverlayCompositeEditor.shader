Shader "Hidden/OverlayCompositeEditor"
{
	Properties
	{
		_MainTex ("", 2D) = "" {}
	...
	SubShader
	{
		Pass
		{
			...
			void frag_main()
			{
				fragment_unnamed_9 = _Occlude.Sample(sampler_Occlude, fragment_input_0);
				fragment_unnamed_26 = fragment_unnamed_9.y + fragment_unnamed_9.x;
				fragment_unnamed_26 = fragment_unnamed_9.z + fragment_unnamed_26;
				fragment_unnamed_42 = fragment_unnamed_26 == 0.0f;
				fragment_unnamed_46 = _MainTex.Sample(sampler_MainTex, fragment_input_0);
				bool4 fragment_unnamed_60 = fragment_unnamed_42.xxxx;
				fragment_output_0 = float4(fragment_unnamed_60.x ? fragment_unnamed_46.x : fragment_unnamed_9.x, fragment_unnamed_60.y ? fragment_unnamed_46.y : fragment_unnamed_9.y, fragment_unnamed_60.z ? fragment_unnamed_46.z : fragment_unnamed_9.z, fragment_unnamed_60.w ? fragment_unnamed_46.w : fragment_unnamed_9.w);
			}
			...
			void frag_main()
			{
				float4 fragment_unnamed_37 = _Occlude.Sample(sampler_Occlude, float2(fragment_input_1.x, fragment_input_1.y));
				float fragment_unnamed_39 = fragment_unnamed_37.x;
				float fragment_unnamed_40 = fragment_unnamed_37.y;
				float fragment_unnamed_41 = fragment_unnamed_37.z;
				precise float fragment_unnamed_43 = fragment_unnamed_40 + fragment_unnamed_39;
				precise float fragment_unnamed_44 = fragment_unnamed_41 + fragment_unnamed_43;
				bool fragment_unnamed_46 = fragment_unnamed_44 == 0.0f;
				float4 fragment_unnamed_52 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_1.x, fragment_input_1.y));
				fragment_output_0.x = fragment_unnamed_46 ? fragment_unnamed_52.x : fragment_unnamed_39;
				fragment_output_0.y = fragment_unnamed_46 ? fragment_unnamed_52.y : fragment_unnamed_40;
				fragment_output_0.z = fragment_unnamed_46 ? fragment_unnamed_52.z : fragment_unnamed_41;
				fragment_output_0.w = fragment_unnamed_46 ? fragment_unnamed_52.w : fragment_unnamed_37.w;
			}
