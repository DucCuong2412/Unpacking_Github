Shader "UI/Bright"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			void frag_main()
			{
				fragment_unnamed_9 = fragment_input_0.xyz + fragment_input_0.xyz;
				fragment_unnamed_20 = _MainTex.Sample(sampler_MainTex, fragment_input_1).xw;
				fragment_unnamed_20 += _TextureSampleAdd.xw;
				fragment_unnamed_49 = 0.0f >= fragment_unnamed_20.x;
				float3 fragment_unnamed_59;
				if (fragment_unnamed_49)
				{
					fragment_unnamed_59 = _Dark.xyz;
				}
				else
				{
					fragment_unnamed_59 = fragment_unnamed_9;
				}
				fragment_unnamed_9 = fragment_unnamed_59;
				float3 fragment_unnamed_74 = fragment_unnamed_9 * fragment_unnamed_20.yyy;
				fragment_output_0 = float4(fragment_unnamed_74.x, fragment_unnamed_74.y, fragment_unnamed_74.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_20.y * fragment_input_0.w;
			}
			...
			static bool fragment_unnamed_72;
			static float3 fragment_unnamed_79;

			void frag_main()
			{
				float2 fragment_unnamed_25 = _MainTex.Sample(sampler_MainTex, fragment_input_1).xw;
				fragment_unnamed_9 = float4(fragment_unnamed_25.x, fragment_unnamed_25.y, fragment_unnamed_9.z, fragment_unnamed_9.w);
				float2 fragment_unnamed_39 = fragment_unnamed_9.xy + _TextureSampleAdd.xw;
				fragment_unnamed_9 = float4(fragment_unnamed_39.x, fragment_unnamed_39.y, fragment_unnamed_9.z, fragment_unnamed_9.w);
				fragment_unnamed_43 = (fragment_unnamed_9.y * fragment_input_0.w) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_59 = fragment_unnamed_43 < 0.0f;
				if ((int(fragment_unnamed_59) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_72 = 0.0f >= fragment_unnamed_9.x;
				fragment_unnamed_79 = fragment_input_0.xyz + fragment_input_0.xyz;
				float3 fragment_unnamed_87;
				if (fragment_unnamed_72)
				{
					fragment_unnamed_87 = _Dark.xyz;
				}
				else
				{
					fragment_unnamed_87 = fragment_unnamed_79;
				}
				fragment_unnamed_9 = float4(fragment_unnamed_87.x, fragment_unnamed_9.y, fragment_unnamed_87.y, fragment_unnamed_87.z);
				float3 fragment_unnamed_104 = fragment_unnamed_9.xzw * fragment_unnamed_9.yyy;
				fragment_output_0 = float4(fragment_unnamed_104.x, fragment_unnamed_104.y, fragment_unnamed_104.z, fragment_output_0.w);
				fragment_unnamed_9.x = fragment_unnamed_9.y * fragment_input_0.w;
			...
			void frag_main()
			{
				...
				fragment_unnamed_81 = _MainTex.Sample(sampler_MainTex, fragment_input_1).xw;
				fragment_unnamed_81 += _TextureSampleAdd.xw;
				fragment_unnamed_103 = fragment_unnamed_81.y * fragment_input_0.w;
				fragment_output_0.w = fragment_unnamed_40.x * fragment_unnamed_103;
				fragment_unnamed_9.x = 0.0f >= fragment_unnamed_81.x;
				fragment_unnamed_125 = fragment_input_0.xyz + fragment_input_0.xyz;
				float3 fragment_unnamed_134;
				if (fragment_unnamed_9.x)
				{
					fragment_unnamed_134 = _Dark.xyz;
				}
				else
				{
					fragment_unnamed_134 = fragment_unnamed_125;
				}
				fragment_unnamed_40 = float4(fragment_unnamed_134.x, fragment_unnamed_134.y, fragment_unnamed_40.z, fragment_unnamed_134.z);
				float3 fragment_unnamed_150 = fragment_unnamed_40.xyw * fragment_unnamed_81.yyy;
				fragment_output_0 = float4(fragment_unnamed_150.x, fragment_unnamed_150.y, fragment_unnamed_150.z, fragment_output_0.w);
			}
			...
			static float2 fragment_unnamed_81;
			static float fragment_unnamed_103;
			static float3 fragment_unnamed_113;
			...
			void frag_main()
			{
				...
				fragment_unnamed_81 += _TextureSampleAdd.xw;
				fragment_unnamed_103 = fragment_unnamed_81.y * fragment_input_0.w;
				fragment_unnamed_113.x = (fragment_unnamed_103 * fragment_unnamed_40.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_40.x *= fragment_unnamed_103;
				fragment_output_0.w = fragment_unnamed_40.x;
				fragment_unnamed_9.x = fragment_unnamed_113.x < 0.0f;
				if ((int(fragment_unnamed_9.x) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_9.x = 0.0f >= fragment_unnamed_81.x;
				fragment_unnamed_113 = fragment_input_0.xyz + fragment_input_0.xyz;
				float3 fragment_unnamed_158;
				if (fragment_unnamed_9.x)
				{
					fragment_unnamed_158 = _Dark.xyz;
				}
				else
				{
					fragment_unnamed_158 = fragment_unnamed_113;
				}
				fragment_unnamed_40 = float4(fragment_unnamed_158.x, fragment_unnamed_158.y, fragment_unnamed_40.z, fragment_unnamed_158.z);
				float3 fragment_unnamed_173 = fragment_unnamed_40.xyw * fragment_unnamed_81.yyy;
				fragment_output_0 = float4(fragment_unnamed_173.x, fragment_unnamed_173.y, fragment_unnamed_173.z, fragment_output_0.w);
			}
			...
			void frag_main()
			{
				precise float fragment_unnamed_46 = fragment_input_1.x + fragment_input_1.x;
				precise float fragment_unnamed_47 = fragment_input_1.y + fragment_input_1.y;
				precise float fragment_unnamed_48 = fragment_input_1.z + fragment_input_1.z;
				float4 fragment_unnamed_56 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y));
				precise float fragment_unnamed_66 = fragment_unnamed_56.x + fragment_uniform_buffer_0[4u].x;
				precise float fragment_unnamed_67 = fragment_unnamed_56.w + fragment_uniform_buffer_0[4u].w;
				bool fragment_unnamed_69 = 0.0f >= fragment_unnamed_66;
				uint4 fragment_unnamed_74 = asuint(fragment_uniform_buffer_0[3u]);
				precise float fragment_unnamed_87 = asfloat(fragment_unnamed_69 ? fragment_unnamed_74.x : asuint(fragment_unnamed_46)) * fragment_unnamed_67;
				precise float fragment_unnamed_88 = asfloat(fragment_unnamed_69 ? fragment_unnamed_74.y : asuint(fragment_unnamed_47)) * fragment_unnamed_67;
				precise float fragment_unnamed_89 = asfloat(fragment_unnamed_69 ? fragment_unnamed_74.z : asuint(fragment_unnamed_48)) * fragment_unnamed_67;
				fragment_output_0.x = fragment_unnamed_87;
				fragment_output_0.y = fragment_unnamed_88;
				fragment_output_0.z = fragment_unnamed_89;
				precise float fragment_unnamed_96 = fragment_unnamed_67 * fragment_input_1.w;
			...
			void discard_cond(bool fragment_unnamed_109)
			{
				if (fragment_unnamed_109)
				{
					discard_state = true;
				}
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_50 = fragment_unnamed_40.x + fragment_uniform_buffer_0[4u].x;
				precise float fragment_unnamed_51 = fragment_unnamed_40.w + fragment_uniform_buffer_0[4u].w;
				discard_cond(mad(fragment_unnamed_51, fragment_input_1.w, -0.001000000047497451305389404296875f) < 0.0f);
				bool fragment_unnamed_63 = 0.0f >= fragment_unnamed_50;
				precise float fragment_unnamed_77 = fragment_input_1.x + fragment_input_1.x;
				precise float fragment_unnamed_78 = fragment_input_1.y + fragment_input_1.y;
				precise float fragment_unnamed_79 = fragment_input_1.z + fragment_input_1.z;
				uint4 fragment_unnamed_83 = asuint(fragment_uniform_buffer_0[3u]);
				precise float fragment_unnamed_96 = asfloat(fragment_unnamed_63 ? fragment_unnamed_83.x : asuint(fragment_unnamed_77)) * fragment_unnamed_51;
				precise float fragment_unnamed_97 = asfloat(fragment_unnamed_63 ? fragment_unnamed_83.y : asuint(fragment_unnamed_78)) * fragment_unnamed_51;
				precise float fragment_unnamed_98 = asfloat(fragment_unnamed_63 ? fragment_unnamed_83.z : asuint(fragment_unnamed_79)) * fragment_unnamed_51;
				fragment_output_0.x = fragment_unnamed_96;
				fragment_output_0.y = fragment_unnamed_97;
				fragment_output_0.z = fragment_unnamed_98;
				precise float fragment_unnamed_105 = fragment_unnamed_51 * fragment_input_1.w;
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_89 = fragment_unnamed_80.x + fragment_uniform_buffer_0[4u].x;
				precise float fragment_unnamed_90 = fragment_unnamed_80.w + fragment_uniform_buffer_0[4u].w;
				precise float fragment_unnamed_94 = fragment_unnamed_90 * fragment_input_1.w;
				precise float fragment_unnamed_95 = fragment_unnamed_72 * fragment_unnamed_94;
				fragment_output_0.w = fragment_unnamed_95;
				bool fragment_unnamed_98 = 0.0f >= fragment_unnamed_89;
				precise float fragment_unnamed_112 = fragment_input_1.x + fragment_input_1.x;
				precise float fragment_unnamed_113 = fragment_input_1.y + fragment_input_1.y;
				precise float fragment_unnamed_114 = fragment_input_1.z + fragment_input_1.z;
				uint4 fragment_unnamed_118 = asuint(fragment_uniform_buffer_0[3u]);
				precise float fragment_unnamed_131 = asfloat(fragment_unnamed_98 ? fragment_unnamed_118.x : asuint(fragment_unnamed_112)) * fragment_unnamed_90;
				precise float fragment_unnamed_132 = asfloat(fragment_unnamed_98 ? fragment_unnamed_118.y : asuint(fragment_unnamed_113)) * fragment_unnamed_90;
				precise float fragment_unnamed_133 = asfloat(fragment_unnamed_98 ? fragment_unnamed_118.z : asuint(fragment_unnamed_114)) * fragment_unnamed_90;
				fragment_output_0.x = fragment_unnamed_131;
				fragment_output_0.y = fragment_unnamed_132;
				fragment_output_0.z = fragment_unnamed_133;
			}
			...
			void discard_cond(bool fragment_unnamed_146)
			{
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_90 = fragment_unnamed_80.w + fragment_uniform_buffer_0[4u].w;
				precise float fragment_unnamed_94 = fragment_unnamed_90 * fragment_input_1.w;
				precise float fragment_unnamed_98 = fragment_unnamed_72 * fragment_unnamed_94;
				fragment_output_0.w = fragment_unnamed_98;
				discard_cond(mad(fragment_unnamed_94, fragment_unnamed_72, -0.001000000047497451305389404296875f) < 0.0f);
				bool fragment_unnamed_105 = 0.0f >= fragment_unnamed_89;
				precise float fragment_unnamed_119 = fragment_input_1.x + fragment_input_1.x;
				precise float fragment_unnamed_120 = fragment_input_1.y + fragment_input_1.y;
				precise float fragment_unnamed_121 = fragment_input_1.z + fragment_input_1.z;
				uint4 fragment_unnamed_125 = asuint(fragment_uniform_buffer_0[3u]);
				precise float fragment_unnamed_138 = asfloat(fragment_unnamed_105 ? fragment_unnamed_125.x : asuint(fragment_unnamed_119)) * fragment_unnamed_90;
				precise float fragment_unnamed_139 = asfloat(fragment_unnamed_105 ? fragment_unnamed_125.y : asuint(fragment_unnamed_120)) * fragment_unnamed_90;
				precise float fragment_unnamed_140 = asfloat(fragment_unnamed_105 ? fragment_unnamed_125.z : asuint(fragment_unnamed_121)) * fragment_unnamed_90;
