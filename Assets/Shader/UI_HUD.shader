Shader "UI/HUD"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			static bool fragment_unnamed_42;
			static float fragment_unnamed_50;
			...
			void frag_main()
			{
				...
				fragment_unnamed_42 = 0.0f >= fragment_unnamed_9.x;
				fragment_unnamed_50 = float(fragment_unnamed_42);
				float3 fragment_unnamed_66 = (fragment_unnamed_50.xxx * _Dark.xyz) + fragment_unnamed_9.xyz;
			...
			void frag_main()
			{
				...
				fragment_unnamed_54 = 0.0f >= fragment_unnamed_9.x;
				fragment_unnamed_36 = float(fragment_unnamed_54);
				float3 fragment_unnamed_85 = (fragment_unnamed_36.xxx * _Dark.xyz) + fragment_unnamed_9.xyz;
				fragment_output_0 = float4(fragment_unnamed_85.x, fragment_unnamed_85.y, fragment_unnamed_85.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_9.w;
			}
			...
			void frag_main()
			{
				...
				fragment_unnamed_9.x = 0.0f >= fragment_unnamed_80.x;
				fragment_unnamed_40.x = float(fragment_unnamed_9.x);
				float3 fragment_unnamed_131 = (fragment_unnamed_40.xxx * _Dark.xyz) + fragment_unnamed_80.xyz;
			...
			void frag_main()
			{
				...
				fragment_unnamed_9.x = 0.0f >= fragment_unnamed_80.x;
				fragment_unnamed_40.x = float(fragment_unnamed_9.x);
				float3 fragment_unnamed_154 = (fragment_unnamed_40.xxx * _Dark.xyz) + fragment_unnamed_80.xyz;
				fragment_output_0 = float4(fragment_unnamed_154.x, fragment_unnamed_154.y, fragment_unnamed_154.z, fragment_output_0.w);
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_54 = fragment_unnamed_40.x + fragment_uniform_buffer_0[4u].x;
				precise float fragment_unnamed_55 = fragment_unnamed_40.y + fragment_uniform_buffer_0[4u].y;
				precise float fragment_unnamed_56 = fragment_unnamed_40.z + fragment_uniform_buffer_0[4u].z;
				precise float fragment_unnamed_57 = fragment_unnamed_40.w + fragment_uniform_buffer_0[4u].w;
				precise float fragment_unnamed_68 = fragment_unnamed_54 * fragment_input_1.x;
				precise float fragment_unnamed_69 = fragment_unnamed_55 * fragment_input_1.y;
				precise float fragment_unnamed_70 = fragment_unnamed_56 * fragment_input_1.z;
				precise float fragment_unnamed_71 = fragment_unnamed_57 * fragment_input_1.w;
				float fragment_unnamed_78 = asfloat(((0.0f >= fragment_unnamed_68) ? 4294967295u : 0u) & 1065353216u);
				fragment_output_0.x = mad(fragment_unnamed_78, fragment_uniform_buffer_0[3u].x, fragment_unnamed_68);
				fragment_output_0.y = mad(fragment_unnamed_78, fragment_uniform_buffer_0[3u].y, fragment_unnamed_69);
				fragment_output_0.z = mad(fragment_unnamed_78, fragment_uniform_buffer_0[3u].z, fragment_unnamed_70);
				fragment_output_0.w = fragment_unnamed_71;
			}
			...
			void discard_cond(bool fragment_unnamed_103)
			{
				if (fragment_unnamed_103)
				{
					discard_state = true;
				}
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_74 = fragment_unnamed_55 * fragment_input_1.y;
				precise float fragment_unnamed_75 = fragment_unnamed_56 * fragment_input_1.z;
				precise float fragment_unnamed_76 = fragment_unnamed_57 * fragment_input_1.w;
				discard_cond(mad(fragment_unnamed_57, fragment_input_1.w, -0.001000000047497451305389404296875f) < 0.0f);
				float fragment_unnamed_87 = asfloat(((0.0f >= fragment_unnamed_73) ? 4294967295u : 0u) & 1065353216u);
				fragment_output_0.x = mad(fragment_unnamed_87, fragment_uniform_buffer_0[3u].x, fragment_unnamed_73);
				fragment_output_0.y = mad(fragment_unnamed_87, fragment_uniform_buffer_0[3u].y, fragment_unnamed_74);
				fragment_output_0.z = mad(fragment_unnamed_87, fragment_uniform_buffer_0[3u].z, fragment_unnamed_75);
				fragment_output_0.w = fragment_unnamed_76;
				discard_exit();
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_93 = fragment_unnamed_80.x + fragment_uniform_buffer_0[4u].x;
				precise float fragment_unnamed_94 = fragment_unnamed_80.y + fragment_uniform_buffer_0[4u].y;
				precise float fragment_unnamed_95 = fragment_unnamed_80.z + fragment_uniform_buffer_0[4u].z;
				precise float fragment_unnamed_96 = fragment_unnamed_80.w + fragment_uniform_buffer_0[4u].w;
				precise float fragment_unnamed_107 = fragment_unnamed_93 * fragment_input_1.x;
				precise float fragment_unnamed_108 = fragment_unnamed_94 * fragment_input_1.y;
				precise float fragment_unnamed_109 = fragment_unnamed_95 * fragment_input_1.z;
				precise float fragment_unnamed_110 = fragment_unnamed_96 * fragment_input_1.w;
				precise float fragment_unnamed_111 = fragment_unnamed_72 * fragment_unnamed_110;
				fragment_output_0.w = fragment_unnamed_111;
				float fragment_unnamed_117 = asfloat(((0.0f >= fragment_unnamed_107) ? 4294967295u : 0u) & 1065353216u);
				fragment_output_0.x = mad(fragment_unnamed_117, fragment_uniform_buffer_0[3u].x, fragment_unnamed_107);
				fragment_output_0.y = mad(fragment_unnamed_117, fragment_uniform_buffer_0[3u].y, fragment_unnamed_108);
				fragment_output_0.z = mad(fragment_unnamed_117, fragment_uniform_buffer_0[3u].z, fragment_unnamed_109);
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_109 = fragment_unnamed_95 * fragment_input_1.z;
				precise float fragment_unnamed_110 = fragment_unnamed_96 * fragment_input_1.w;
				precise float fragment_unnamed_114 = fragment_unnamed_72 * fragment_unnamed_110;
				fragment_output_0.w = fragment_unnamed_114;
				discard_cond(mad(fragment_unnamed_110, fragment_unnamed_72, -0.001000000047497451305389404296875f) < 0.0f);
				float fragment_unnamed_124 = asfloat(((0.0f >= fragment_unnamed_107) ? 4294967295u : 0u) & 1065353216u);
				fragment_output_0.x = mad(fragment_unnamed_124, fragment_uniform_buffer_0[3u].x, fragment_unnamed_107);
				fragment_output_0.y = mad(fragment_unnamed_124, fragment_uniform_buffer_0[3u].y, fragment_unnamed_108);
				fragment_output_0.z = mad(fragment_unnamed_124, fragment_uniform_buffer_0[3u].z, fragment_unnamed_109);
				discard_exit();
			}
