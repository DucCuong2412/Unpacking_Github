	...
	SubShader
	{
		...
		Pass
		{
			...
			void vert_main()
			{
				...
				gl_Position.x = mad(vertex_uniform_buffer_2[20u].x, vertex_unnamed_87, mad(vertex_uniform_buffer_2[19u].x, vertex_unnamed_86, mad(vertex_uniform_buffer_2[17u].x, vertex_unnamed_84, vertex_unnamed_95)));
				gl_Position.y = mad(vertex_uniform_buffer_2[20u].y, vertex_unnamed_87, mad(vertex_uniform_buffer_2[19u].y, vertex_unnamed_86, mad(vertex_uniform_buffer_2[17u].y, vertex_unnamed_84, vertex_unnamed_96)));
				...
				gl_Position.w = mad(vertex_uniform_buffer_2[20u].w, vertex_unnamed_87, mad(vertex_uniform_buffer_2[19u].w, vertex_unnamed_86, mad(vertex_uniform_buffer_2[17u].w, vertex_unnamed_84, vertex_unnamed_98)));
				precise float vertex_unnamed_151 = vertex_input_1.x * vertex_uniform_buffer_0[2u].x;
				precise float vertex_unnamed_152 = vertex_input_1.y * vertex_uniform_buffer_0[2u].y;
				precise float vertex_unnamed_153 = vertex_input_1.z * vertex_uniform_buffer_0[2u].z;
				precise float vertex_unnamed_154 = vertex_input_1.w * vertex_uniform_buffer_0[2u].w;
				vertex_output_1.x = vertex_unnamed_151;
				vertex_output_1.y = vertex_unnamed_152;
				vertex_output_1.z = vertex_unnamed_153;
				vertex_output_1.w = vertex_unnamed_154;
				vertex_output_2.x = mad(vertex_input_2.x, vertex_uniform_buffer_0[5u].x, vertex_uniform_buffer_0[5u].z);
				vertex_output_2.y = mad(vertex_input_2.y, vertex_uniform_buffer_0[5u].y, vertex_uniform_buffer_0[5u].w);
			...
			void frag_main()
			{
				...
				float3 fragment_unnamed_44 = fragment_unnamed_9.xyz + fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_44.x, fragment_unnamed_44.y, fragment_unnamed_44.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_9.w * fragment_input_0.w;
			}
			...
			void frag_main()
			{
				...
				fragment_unnamed_51 = fragment_unnamed_36 < 0.0f;
				if ((int(fragment_unnamed_51) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_64 = fragment_unnamed_9.w * fragment_input_0.w;
				float3 fragment_unnamed_77 = fragment_unnamed_9.xyz + fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_77.x, fragment_unnamed_77.y, fragment_unnamed_77.z, fragment_output_0.w);
			...
			static float fragment_unnamed_100;
			...
			void frag_main()
			{
				...
				fragment_unnamed_100 = fragment_unnamed_80.w * fragment_input_0.w;
				float3 fragment_unnamed_115 = fragment_unnamed_80.xyz + fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_115.x, fragment_unnamed_115.y, fragment_unnamed_115.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_40.x * fragment_unnamed_100;
			}
			...
			void frag_main()
			{
				...
				float3 fragment_unnamed_115 = fragment_unnamed_80.xyz + fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_115.x, fragment_unnamed_115.y, fragment_unnamed_115.z, fragment_output_0.w);
				fragment_unnamed_118 = (fragment_unnamed_100 * fragment_unnamed_40.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_40.x *= fragment_unnamed_100;
				fragment_output_0.w = fragment_unnamed_40.x;
				fragment_unnamed_9.x = fragment_unnamed_118 < 0.0f;
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_65 = fragment_unnamed_54 + fragment_input_1.x;
				precise float fragment_unnamed_66 = fragment_unnamed_55 + fragment_input_1.y;
				precise float fragment_unnamed_67 = fragment_unnamed_56 + fragment_input_1.z;
				fragment_output_0.x = fragment_unnamed_65;
				fragment_output_0.y = fragment_unnamed_66;
				fragment_output_0.z = fragment_unnamed_67;
				precise float fragment_unnamed_74 = fragment_unnamed_57 * fragment_input_1.w;
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_78 = fragment_unnamed_54 + fragment_input_1.x;
				precise float fragment_unnamed_79 = fragment_unnamed_55 + fragment_input_1.y;
				precise float fragment_unnamed_80 = fragment_unnamed_56 + fragment_input_1.z;
				fragment_output_0.x = fragment_unnamed_78;
				fragment_output_0.y = fragment_unnamed_79;
				fragment_output_0.z = fragment_unnamed_80;
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_99 = fragment_unnamed_96 * fragment_input_1.w;
				...
				fragment_output_0.x = fragment_unnamed_107;
				fragment_output_0.y = fragment_unnamed_108;
				fragment_output_0.z = fragment_unnamed_109;
				precise float fragment_unnamed_114 = fragment_unnamed_72 * fragment_unnamed_99;
			...
			void frag_main()
			{
				...
				fragment_output_0.y = fragment_unnamed_108;
				fragment_output_0.z = fragment_unnamed_109;
				precise float fragment_unnamed_117 = fragment_unnamed_72 * fragment_unnamed_99;
				fragment_output_0.w = fragment_unnamed_117;
				discard_cond(mad(fragment_unnamed_99, fragment_unnamed_72, -0.001000000047497451305389404296875f) < 0.0f);
				discard_exit();
			}
