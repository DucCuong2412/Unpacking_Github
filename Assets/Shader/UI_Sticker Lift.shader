	...
	SubShader
	{
		...
		Pass
		{
			...
			void frag_main()
			{
				...
				fragment_unnamed_8 *= _Shadow.w;
				float3 fragment_unnamed_54 = fragment_unnamed_8.xxx * _Shadow.xyz;
				fragment_output_0 = float4(fragment_unnamed_54.x, fragment_unnamed_54.y, fragment_unnamed_54.z, fragment_output_0.w);
			...
			static float fragment_unnamed_8;
			static float fragment_unnamed_35;
			...
			void frag_main()
			{
				fragment_unnamed_8 = _MainTex.Sample(sampler_MainTex, fragment_input_1).w;
				fragment_unnamed_8 *= fragment_input_0.w;
				fragment_unnamed_35 = (_Shadow.w * fragment_unnamed_8) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_8 *= _Shadow.w;
				fragment_unnamed_54 = fragment_unnamed_35 < 0.0f;
				if ((int(fragment_unnamed_54) * (-1)) != 0)
				{
					discard;
				}
				float3 fragment_unnamed_76 = fragment_unnamed_8.xxx * _Shadow.xyz;
				fragment_output_0 = float4(fragment_unnamed_76.x, fragment_unnamed_76.y, fragment_unnamed_76.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_8;
			}
			...
			void frag_main()
			{
				...
				fragment_unnamed_80 *= fragment_input_0.w;
				fragment_unnamed_80 *= _Shadow.w;
				fragment_unnamed_40.x *= fragment_unnamed_80;
				float3 fragment_unnamed_121 = fragment_unnamed_40.xxx * _Shadow.xyz;
				fragment_output_0 = float4(fragment_unnamed_121.x, fragment_unnamed_121.y, fragment_unnamed_121.z, fragment_output_0.w);
			...
			static float4 fragment_unnamed_40;
			static float fragment_unnamed_80;
			static float fragment_unnamed_108;
			...
			void frag_main()
			{
				...
				fragment_unnamed_80 *= fragment_input_0.w;
				fragment_unnamed_80 *= _Shadow.w;
				fragment_unnamed_108 = (fragment_unnamed_80 * fragment_unnamed_40.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_40.x *= fragment_unnamed_80;
				fragment_unnamed_120 = fragment_unnamed_108 < 0.0f;
				if ((int(fragment_unnamed_120) * (-1)) != 0)
				{
					discard;
				}
				float3 fragment_unnamed_139 = fragment_unnamed_40.xxx * _Shadow.xyz;
				fragment_output_0 = float4(fragment_unnamed_139.x, fragment_unnamed_139.y, fragment_unnamed_139.z, fragment_output_0.w);
				fragment_output_0.w = fragment_unnamed_40.x;
			}
			...
			void frag_main()
			{
				precise float fragment_unnamed_46 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				precise float fragment_unnamed_51 = fragment_unnamed_46 * fragment_uniform_buffer_0[3u].w;
				precise float fragment_unnamed_57 = fragment_unnamed_51 * fragment_uniform_buffer_0[3u].x;
				precise float fragment_unnamed_58 = fragment_unnamed_51 * fragment_uniform_buffer_0[3u].y;
				precise float fragment_unnamed_59 = fragment_unnamed_51 * fragment_uniform_buffer_0[3u].z;
				fragment_output_0.x = fragment_unnamed_57;
				fragment_output_0.y = fragment_unnamed_58;
				fragment_output_0.z = fragment_unnamed_59;
				fragment_output_0.w = fragment_unnamed_51;
			}

			Fragment_Stage_Output frag(Fragment_Stage_Input stage_input)
			{
				fragment_uniform_buffer_0[3] = float4(_Shadow[0], _Shadow[1], _Shadow[2], _Shadow[3]);
			...
			void frag_main()
			{
				discard_state = false;
				precise float fragment_unnamed_46 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				precise float fragment_unnamed_57 = fragment_unnamed_46 * fragment_uniform_buffer_0[3u].w;
				discard_cond(mad(fragment_uniform_buffer_0[3u].w, fragment_unnamed_46, -0.001000000047497451305389404296875f) < 0.0f);
				precise float fragment_unnamed_68 = fragment_unnamed_57 * fragment_uniform_buffer_0[3u].x;
				precise float fragment_unnamed_69 = fragment_unnamed_57 * fragment_uniform_buffer_0[3u].y;
				precise float fragment_unnamed_70 = fragment_unnamed_57 * fragment_uniform_buffer_0[3u].z;
				fragment_output_0.x = fragment_unnamed_68;
				fragment_output_0.y = fragment_unnamed_69;
				fragment_output_0.z = fragment_unnamed_70;
				fragment_output_0.w = fragment_unnamed_57;
				discard_exit();
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_86 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				precise float fragment_unnamed_90 = fragment_unnamed_86 * fragment_uniform_buffer_0[3u].w;
				precise float fragment_unnamed_91 = fragment_unnamed_72 * fragment_unnamed_90;
				precise float fragment_unnamed_97 = fragment_unnamed_91 * fragment_uniform_buffer_0[3u].x;
				precise float fragment_unnamed_98 = fragment_unnamed_91 * fragment_uniform_buffer_0[3u].y;
				precise float fragment_unnamed_99 = fragment_unnamed_91 * fragment_uniform_buffer_0[3u].z;
				fragment_output_0.x = fragment_unnamed_97;
				fragment_output_0.y = fragment_unnamed_98;
				fragment_output_0.z = fragment_unnamed_99;
				fragment_output_0.w = fragment_unnamed_91;
			}
			...
			void discard_cond(bool fragment_unnamed_115)
			{
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_86 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				precise float fragment_unnamed_90 = fragment_unnamed_86 * fragment_uniform_buffer_0[3u].w;
				precise float fragment_unnamed_94 = fragment_unnamed_72 * fragment_unnamed_90;
				discard_cond(mad(fragment_unnamed_90, fragment_unnamed_72, -0.001000000047497451305389404296875f) < 0.0f);
				precise float fragment_unnamed_104 = fragment_unnamed_94 * fragment_uniform_buffer_0[3u].x;
				precise float fragment_unnamed_105 = fragment_unnamed_94 * fragment_uniform_buffer_0[3u].y;
				precise float fragment_unnamed_106 = fragment_unnamed_94 * fragment_uniform_buffer_0[3u].z;
				fragment_output_0.x = fragment_unnamed_104;
				fragment_output_0.y = fragment_unnamed_105;
				fragment_output_0.z = fragment_unnamed_106;
				fragment_output_0.w = fragment_unnamed_94;
				discard_exit();
			}
		...
		Pass
		{
			...
			void vert_main()
			{
				precise float vertex_unnamed_42 = vertex_input_0.y + 4.0f;
				precise float vertex_unnamed_44 = vertex_input_0.x + (-4.0f);
				precise float vertex_unnamed_53 = vertex_unnamed_42 * vertex_uniform_buffer_1[1u].x;
				precise float vertex_unnamed_54 = vertex_unnamed_42 * vertex_uniform_buffer_1[1u].y;
				precise float vertex_unnamed_55 = vertex_unnamed_42 * vertex_uniform_buffer_1[1u].z;
				precise float vertex_unnamed_56 = vertex_unnamed_42 * vertex_uniform_buffer_1[1u].w;
				precise float vertex_unnamed_87 = mad(vertex_uniform_buffer_1[2u].x, vertex_input_0.z, mad(vertex_uniform_buffer_1[0u].x, vertex_unnamed_44, vertex_unnamed_53)) + vertex_uniform_buffer_1[3u].x;
				precise float vertex_unnamed_88 = mad(vertex_uniform_buffer_1[2u].y, vertex_input_0.z, mad(vertex_uniform_buffer_1[0u].y, vertex_unnamed_44, vertex_unnamed_54)) + vertex_uniform_buffer_1[3u].y;
				precise float vertex_unnamed_89 = mad(vertex_uniform_buffer_1[2u].z, vertex_input_0.z, mad(vertex_uniform_buffer_1[0u].z, vertex_unnamed_44, vertex_unnamed_55)) + vertex_uniform_buffer_1[3u].z;
				precise float vertex_unnamed_90 = mad(vertex_uniform_buffer_1[2u].w, vertex_input_0.z, mad(vertex_uniform_buffer_1[0u].w, vertex_unnamed_44, vertex_unnamed_56)) + vertex_uniform_buffer_1[3u].w;
				...
				vertex_output_1.x = vertex_unnamed_154;
				vertex_output_1.y = vertex_unnamed_155;
				vertex_output_1.z = vertex_unnamed_156;
				vertex_output_1.w = vertex_unnamed_157;
				vertex_output_2.x = vertex_input_2.x;
				vertex_output_2.y = vertex_input_2.y;
				precise float vertex_unnamed_176 = vertex_input_0.x + (-4.0f);
				precise float vertex_unnamed_177 = vertex_input_0.y + 4.0f;
				precise float vertex_unnamed_178 = vertex_input_0.z + 0.0f;
				precise float vertex_unnamed_180 = vertex_input_0.w + 0.0f;
				vertex_output_3.x = vertex_unnamed_176;
				vertex_output_3.y = vertex_unnamed_177;
				vertex_output_3.z = vertex_unnamed_178;
				vertex_output_3.w = vertex_unnamed_180;
			}
			...
			void vert_main()
			{
				float2 vertex_unnamed_18 = vertex_input_0.yx + float2(4.0f, -4.0f);
				vertex_unnamed_9 = float4(vertex_unnamed_18.x, vertex_unnamed_18.y, vertex_unnamed_9.z, vertex_unnamed_9.w);
				vertex_unnamed_21 = vertex_unnamed_9.xxxx * unity_ObjectToWorld__array[1];
				vertex_unnamed_9 = (unity_ObjectToWorld__array[0] * vertex_unnamed_9.yyyy) + vertex_unnamed_21;
				vertex_unnamed_9 = (unity_ObjectToWorld__array[2] * vertex_input_0.zzzz) + vertex_unnamed_9;
				vertex_unnamed_9 += unity_ObjectToWorld__array[3];
				vertex_unnamed_21 = vertex_unnamed_9.yyyy * unity_MatrixVP__array[1];
				vertex_unnamed_21 = (unity_MatrixVP__array[0] * vertex_unnamed_9.xxxx) + vertex_unnamed_21;
				vertex_unnamed_21 = (unity_MatrixVP__array[2] * vertex_unnamed_9.zzzz) + vertex_unnamed_21;
				gl_Position = (unity_MatrixVP__array[3] * vertex_unnamed_9.wwww) + vertex_unnamed_21;
				vertex_output_0 = vertex_input_1 * _Color;
				vertex_output_1 = vertex_input_2;
				vertex_output_2 = vertex_input_0 + float4(-4.0f, 4.0f, 0.0f, 0.0f);
			}
