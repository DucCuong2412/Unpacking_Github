Shader "TextMeshPro/Bitmap Outline"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			void vert_main()
			{
				precise float vertex_unnamed_50 = vertex_uniform_buffer_0[3u].x + vertex_uniform_buffer_0[3u].y;
				precise float vertex_unnamed_54 = vertex_unnamed_50 + vertex_input_0.x;
				precise float vertex_unnamed_57 = vertex_input_0.w * 0.5f;
				precise float vertex_unnamed_63 = vertex_unnamed_57 / vertex_uniform_buffer_1[6u].x;
				precise float vertex_unnamed_64 = vertex_unnamed_57 / vertex_uniform_buffer_1[6u].y;
				precise float vertex_unnamed_71 = vertex_input_0.y + vertex_uniform_buffer_0[3u].z;
				precise float vertex_unnamed_72 = vertex_unnamed_63 + vertex_unnamed_54;
				precise float vertex_unnamed_73 = vertex_unnamed_64 + vertex_unnamed_71;
				precise float vertex_unnamed_80 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].x;
				precise float vertex_unnamed_81 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].y;
				precise float vertex_unnamed_82 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].z;
				precise float vertex_unnamed_83 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].w;
				precise float vertex_unnamed_114 = mad(vertex_uniform_buffer_2[2u].x, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].x, vertex_unnamed_72, vertex_unnamed_80)) + vertex_uniform_buffer_2[3u].x;
				precise float vertex_unnamed_115 = mad(vertex_uniform_buffer_2[2u].y, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].y, vertex_unnamed_72, vertex_unnamed_81)) + vertex_uniform_buffer_2[3u].y;
				precise float vertex_unnamed_116 = mad(vertex_uniform_buffer_2[2u].z, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].z, vertex_unnamed_72, vertex_unnamed_82)) + vertex_uniform_buffer_2[3u].z;
				precise float vertex_unnamed_117 = mad(vertex_uniform_buffer_2[2u].w, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].w, vertex_unnamed_72, vertex_unnamed_83)) + vertex_uniform_buffer_2[3u].w;
				precise float vertex_unnamed_125 = vertex_unnamed_115 * vertex_uniform_buffer_3[18u].x;
				precise float vertex_unnamed_126 = vertex_unnamed_115 * vertex_uniform_buffer_3[18u].y;
				precise float vertex_unnamed_127 = vertex_unnamed_115 * vertex_uniform_buffer_3[18u].z;
				precise float vertex_unnamed_128 = vertex_unnamed_115 * vertex_uniform_buffer_3[18u].w;
				float vertex_unnamed_161 = mad(vertex_uniform_buffer_3[20u].w, vertex_unnamed_117, mad(vertex_uniform_buffer_3[19u].w, vertex_unnamed_116, mad(vertex_uniform_buffer_3[17u].w, vertex_unnamed_114, vertex_unnamed_128)));
				precise float vertex_unnamed_162 = mad(vertex_uniform_buffer_3[20u].x, vertex_unnamed_117, mad(vertex_uniform_buffer_3[19u].x, vertex_unnamed_116, mad(vertex_uniform_buffer_3[17u].x, vertex_unnamed_114, vertex_unnamed_125))) / vertex_unnamed_161;
				precise float vertex_unnamed_163 = mad(vertex_uniform_buffer_3[20u].y, vertex_unnamed_117, mad(vertex_uniform_buffer_3[19u].y, vertex_unnamed_116, mad(vertex_uniform_buffer_3[17u].y, vertex_unnamed_114, vertex_unnamed_126))) / vertex_unnamed_161;
				precise float vertex_unnamed_168 = vertex_uniform_buffer_1[6u].x * 0.5f;
				precise float vertex_unnamed_169 = vertex_uniform_buffer_1[6u].y * 0.5f;
				precise float vertex_unnamed_170 = vertex_unnamed_162 * vertex_unnamed_168;
				precise float vertex_unnamed_171 = vertex_unnamed_163 * vertex_unnamed_169;
				precise float vertex_unnamed_174 = round(vertex_unnamed_170) / vertex_unnamed_168;
				precise float vertex_unnamed_175 = round(vertex_unnamed_171) / vertex_unnamed_169;
				precise float vertex_unnamed_176 = vertex_unnamed_161 * vertex_unnamed_174;
				precise float vertex_unnamed_177 = vertex_unnamed_161 * vertex_unnamed_175;
				gl_Position.x = vertex_unnamed_176;
				gl_Position.y = vertex_unnamed_177;
				gl_Position.z = mad(vertex_uniform_buffer_3[20u].z, vertex_unnamed_117, mad(vertex_uniform_buffer_3[19u].z, vertex_unnamed_116, mad(vertex_uniform_buffer_3[17u].z, vertex_unnamed_114, vertex_unnamed_127)));
				gl_Position.w = vertex_unnamed_161;
				precise float vertex_unnamed_191 = 0.25f / mad(vertex_uniform_buffer_0[5u].x, 0.25f, vertex_unnamed_161);
				precise float vertex_unnamed_192 = 0.25f / mad(vertex_uniform_buffer_0[5u].y, 0.25f, vertex_unnamed_161);
				vertex_output_3.z = vertex_unnamed_191;
				vertex_output_3.w = vertex_unnamed_192;
				precise float vertex_unnamed_209 = vertex_input_1.x * vertex_uniform_buffer_0[2u].x;
				precise float vertex_unnamed_210 = vertex_input_1.y * vertex_uniform_buffer_0[2u].y;
				precise float vertex_unnamed_211 = vertex_input_1.z * vertex_uniform_buffer_0[2u].z;
				precise float vertex_unnamed_212 = vertex_input_1.w * vertex_uniform_buffer_0[2u].w;
				vertex_output_1.x = vertex_unnamed_209;
				vertex_output_1.y = vertex_unnamed_210;
				vertex_output_1.z = vertex_unnamed_211;
				vertex_output_1.w = vertex_unnamed_212;
				vertex_output_2.x = vertex_input_2.x;
				vertex_output_2.y = vertex_input_2.y;
				precise float vertex_unnamed_239 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].x, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_241 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].y, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_245 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].z, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_246 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].w, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_247 = vertex_unnamed_245 + mad(vertex_unnamed_72, 2.0f, vertex_unnamed_239);
				precise float vertex_unnamed_248 = vertex_unnamed_246 + mad(vertex_unnamed_73, 2.0f, vertex_unnamed_241);
				vertex_output_3.x = vertex_unnamed_247;
				vertex_output_3.y = vertex_unnamed_248;
			}
			...
			Vertex_Stage_Output vert(Vertex_Stage_Input stage_input)
			{
				vertex_uniform_buffer_0[2] = float4(_OutlineColor[0], _OutlineColor[1], _OutlineColor[2], _OutlineColor[3]);

				vertex_uniform_buffer_0[3] = float4(_Outline, vertex_uniform_buffer_0[3][1], vertex_uniform_buffer_0[3][2], vertex_uniform_buffer_0[3][3]);
			...
			static float4 vertex_unnamed_66;
			static float4 vertex_unnamed_93;

			void vert_main()
			{
				vertex_unnamed_9.x = _Outline + _VertexOffsetX;
				vertex_unnamed_9.x += vertex_input_0.x;
				vertex_unnamed_39.x = vertex_input_0.w * 0.5f;
				vertex_unnamed_39 = vertex_unnamed_39.xx / _ScreenParams.xy;
				vertex_unnamed_9.y = vertex_input_0.y + _VertexOffsetY;
				vertex_unnamed_9 = vertex_unnamed_39 + vertex_unnamed_9;
				vertex_unnamed_66 = vertex_unnamed_9.yyyy * unity_ObjectToWorld__array[1];
				vertex_unnamed_66 = (unity_ObjectToWorld__array[0] * vertex_unnamed_9.xxxx) + vertex_unnamed_66;
				vertex_unnamed_66 = (unity_ObjectToWorld__array[2] * vertex_input_0.zzzz) + vertex_unnamed_66;
				vertex_unnamed_66 += unity_ObjectToWorld__array[3];
				vertex_unnamed_93 = vertex_unnamed_66.yyyy * unity_MatrixVP__array[1];
				vertex_unnamed_93 = (unity_MatrixVP__array[0] * vertex_unnamed_66.xxxx) + vertex_unnamed_93;
				vertex_unnamed_93 = (unity_MatrixVP__array[2] * vertex_unnamed_66.zzzz) + vertex_unnamed_93;
				vertex_unnamed_66 = (unity_MatrixVP__array[3] * vertex_unnamed_66.wwww) + vertex_unnamed_93;
				vertex_unnamed_39 = vertex_unnamed_66.xy / vertex_unnamed_66.ww;
				float2 vertex_unnamed_129 = _ScreenParams.xy * 0.5f.xx;
				vertex_unnamed_66 = float4(vertex_unnamed_129.x, vertex_unnamed_129.y, vertex_unnamed_66.z, vertex_unnamed_66.w);
				vertex_unnamed_39 *= vertex_unnamed_66.xy;
				vertex_unnamed_39 = round(vertex_unnamed_39);
				vertex_unnamed_39 /= vertex_unnamed_66.xy;
				float2 vertex_unnamed_149 = vertex_unnamed_66.ww * vertex_unnamed_39;
				gl_Position = float4(vertex_unnamed_149.x, vertex_unnamed_149.y, gl_Position.z, gl_Position.w);
				gl_Position = float4(gl_Position.x, gl_Position.y, vertex_unnamed_66.zw.x, vertex_unnamed_66.zw.y);
				vertex_unnamed_39 = (float2(_MaskSoftnessX, _MaskSoftnessY) * 0.25f.xx) + vertex_unnamed_66.ww;
				float2 vertex_unnamed_174 = 0.25f.xx / vertex_unnamed_39;
				vertex_output_2 = float4(vertex_output_2.x, vertex_output_2.y, vertex_unnamed_174.x, vertex_unnamed_174.y);
				vertex_output_0 = vertex_input_1 * _OutlineColor;
				vertex_output_1 = vertex_input_2;
				vertex_unnamed_66 = max(_ClipRect, (-20000000000.0f).xxxx);
				vertex_unnamed_66 = min(vertex_unnamed_66, 20000000000.0f.xxxx);
				vertex_unnamed_9 = (vertex_unnamed_9 * 2.0f.xx) + (-vertex_unnamed_66.xy);
				float2 vertex_unnamed_210 = (-vertex_unnamed_66.zw) + vertex_unnamed_9;
				vertex_output_2 = float4(vertex_unnamed_210.x, vertex_unnamed_210.y, vertex_output_2.z, vertex_output_2.w);
			}
		...
		Pass
		{
			...
			void vert_main()
			{
				precise float vertex_unnamed_47 = (-0.0f) - vertex_uniform_buffer_0[3u].x;
				precise float vertex_unnamed_52 = vertex_unnamed_47 + vertex_uniform_buffer_0[3u].y;
				precise float vertex_unnamed_56 = vertex_unnamed_52 + vertex_input_0.x;
				precise float vertex_unnamed_59 = vertex_input_0.w * 0.5f;
				precise float vertex_unnamed_65 = vertex_unnamed_59 / vertex_uniform_buffer_1[6u].x;
				precise float vertex_unnamed_66 = vertex_unnamed_59 / vertex_uniform_buffer_1[6u].y;
				precise float vertex_unnamed_73 = vertex_input_0.y + vertex_uniform_buffer_0[3u].z;
				precise float vertex_unnamed_74 = vertex_unnamed_65 + vertex_unnamed_56;
				precise float vertex_unnamed_75 = vertex_unnamed_66 + vertex_unnamed_73;
				precise float vertex_unnamed_82 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].x;
				precise float vertex_unnamed_83 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].y;
				precise float vertex_unnamed_84 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].z;
				precise float vertex_unnamed_85 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].w;
				precise float vertex_unnamed_116 = mad(vertex_uniform_buffer_2[2u].x, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].x, vertex_unnamed_74, vertex_unnamed_82)) + vertex_uniform_buffer_2[3u].x;
				precise float vertex_unnamed_117 = mad(vertex_uniform_buffer_2[2u].y, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].y, vertex_unnamed_74, vertex_unnamed_83)) + vertex_uniform_buffer_2[3u].y;
				precise float vertex_unnamed_118 = mad(vertex_uniform_buffer_2[2u].z, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].z, vertex_unnamed_74, vertex_unnamed_84)) + vertex_uniform_buffer_2[3u].z;
				precise float vertex_unnamed_119 = mad(vertex_uniform_buffer_2[2u].w, vertex_input_0.z, mad(vertex_uniform_buffer_2[0u].w, vertex_unnamed_74, vertex_unnamed_85)) + vertex_uniform_buffer_2[3u].w;
				precise float vertex_unnamed_127 = vertex_unnamed_117 * vertex_uniform_buffer_3[18u].x;
				precise float vertex_unnamed_128 = vertex_unnamed_117 * vertex_uniform_buffer_3[18u].y;
				precise float vertex_unnamed_129 = vertex_unnamed_117 * vertex_uniform_buffer_3[18u].z;
				precise float vertex_unnamed_130 = vertex_unnamed_117 * vertex_uniform_buffer_3[18u].w;
				float vertex_unnamed_163 = mad(vertex_uniform_buffer_3[20u].w, vertex_unnamed_119, mad(vertex_uniform_buffer_3[19u].w, vertex_unnamed_118, mad(vertex_uniform_buffer_3[17u].w, vertex_unnamed_116, vertex_unnamed_130)));
				precise float vertex_unnamed_164 = mad(vertex_uniform_buffer_3[20u].x, vertex_unnamed_119, mad(vertex_uniform_buffer_3[19u].x, vertex_unnamed_118, mad(vertex_uniform_buffer_3[17u].x, vertex_unnamed_116, vertex_unnamed_127))) / vertex_unnamed_163;
				precise float vertex_unnamed_165 = mad(vertex_uniform_buffer_3[20u].y, vertex_unnamed_119, mad(vertex_uniform_buffer_3[19u].y, vertex_unnamed_118, mad(vertex_uniform_buffer_3[17u].y, vertex_unnamed_116, vertex_unnamed_128))) / vertex_unnamed_163;
				precise float vertex_unnamed_170 = vertex_uniform_buffer_1[6u].x * 0.5f;
				precise float vertex_unnamed_171 = vertex_uniform_buffer_1[6u].y * 0.5f;
				precise float vertex_unnamed_172 = vertex_unnamed_164 * vertex_unnamed_170;
				precise float vertex_unnamed_173 = vertex_unnamed_165 * vertex_unnamed_171;
				precise float vertex_unnamed_176 = round(vertex_unnamed_172) / vertex_unnamed_170;
				precise float vertex_unnamed_177 = round(vertex_unnamed_173) / vertex_unnamed_171;
				precise float vertex_unnamed_178 = vertex_unnamed_163 * vertex_unnamed_176;
				precise float vertex_unnamed_179 = vertex_unnamed_163 * vertex_unnamed_177;
				gl_Position.x = vertex_unnamed_178;
				gl_Position.y = vertex_unnamed_179;
				gl_Position.z = mad(vertex_uniform_buffer_3[20u].z, vertex_unnamed_119, mad(vertex_uniform_buffer_3[19u].z, vertex_unnamed_118, mad(vertex_uniform_buffer_3[17u].z, vertex_unnamed_116, vertex_unnamed_129)));
				gl_Position.w = vertex_unnamed_163;
				precise float vertex_unnamed_193 = 0.25f / mad(vertex_uniform_buffer_0[5u].x, 0.25f, vertex_unnamed_163);
				precise float vertex_unnamed_194 = 0.25f / mad(vertex_uniform_buffer_0[5u].y, 0.25f, vertex_unnamed_163);
				vertex_output_3.z = vertex_unnamed_193;
				vertex_output_3.w = vertex_unnamed_194;
				precise float vertex_unnamed_211 = vertex_input_1.x * vertex_uniform_buffer_0[2u].x;
				precise float vertex_unnamed_212 = vertex_input_1.y * vertex_uniform_buffer_0[2u].y;
				precise float vertex_unnamed_213 = vertex_input_1.z * vertex_uniform_buffer_0[2u].z;
				precise float vertex_unnamed_214 = vertex_input_1.w * vertex_uniform_buffer_0[2u].w;
				vertex_output_1.x = vertex_unnamed_211;
				vertex_output_1.y = vertex_unnamed_212;
				vertex_output_1.z = vertex_unnamed_213;
				vertex_output_1.w = vertex_unnamed_214;
				vertex_output_2.x = vertex_input_2.x;
				vertex_output_2.y = vertex_input_2.y;
				precise float vertex_unnamed_241 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].x, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_242 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].y, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_246 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].z, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_247 = (-0.0f) - min(max(vertex_uniform_buffer_0[4u].w, -20000000000.0f), 20000000000.0f);
				precise float vertex_unnamed_248 = vertex_unnamed_246 + mad(vertex_unnamed_74, 2.0f, vertex_unnamed_241);
				precise float vertex_unnamed_249 = vertex_unnamed_247 + mad(vertex_unnamed_75, 2.0f, vertex_unnamed_242);
				vertex_output_3.x = vertex_unnamed_248;
				vertex_output_3.y = vertex_unnamed_249;
			}
			...
			static float2 vertex_unnamed_9;
			static float2 vertex_unnamed_40;
			static float4 vertex_unnamed_67;
			static float4 vertex_unnamed_94;

			void vert_main()
			{
				vertex_unnamed_9.x = (-_Outline) + _VertexOffsetX;
				vertex_unnamed_9.x += vertex_input_0.x;
				vertex_unnamed_40.x = vertex_input_0.w * 0.5f;
				vertex_unnamed_40 = vertex_unnamed_40.xx / _ScreenParams.xy;
				vertex_unnamed_9.y = vertex_input_0.y + _VertexOffsetY;
				vertex_unnamed_9 = vertex_unnamed_40 + vertex_unnamed_9;
				vertex_unnamed_67 = vertex_unnamed_9.yyyy * unity_ObjectToWorld__array[1];
				vertex_unnamed_67 = (unity_ObjectToWorld__array[0] * vertex_unnamed_9.xxxx) + vertex_unnamed_67;
				vertex_unnamed_67 = (unity_ObjectToWorld__array[2] * vertex_input_0.zzzz) + vertex_unnamed_67;
				vertex_unnamed_67 += unity_ObjectToWorld__array[3];
				vertex_unnamed_94 = vertex_unnamed_67.yyyy * unity_MatrixVP__array[1];
				vertex_unnamed_94 = (unity_MatrixVP__array[0] * vertex_unnamed_67.xxxx) + vertex_unnamed_94;
				vertex_unnamed_94 = (unity_MatrixVP__array[2] * vertex_unnamed_67.zzzz) + vertex_unnamed_94;
				vertex_unnamed_67 = (unity_MatrixVP__array[3] * vertex_unnamed_67.wwww) + vertex_unnamed_94;
				vertex_unnamed_40 = vertex_unnamed_67.xy / vertex_unnamed_67.ww;
				float2 vertex_unnamed_130 = _ScreenParams.xy * 0.5f.xx;
				vertex_unnamed_67 = float4(vertex_unnamed_130.x, vertex_unnamed_130.y, vertex_unnamed_67.z, vertex_unnamed_67.w);
				vertex_unnamed_40 *= vertex_unnamed_67.xy;
				vertex_unnamed_40 = round(vertex_unnamed_40);
				vertex_unnamed_40 /= vertex_unnamed_67.xy;
				float2 vertex_unnamed_150 = vertex_unnamed_67.ww * vertex_unnamed_40;
				gl_Position = float4(vertex_unnamed_150.x, vertex_unnamed_150.y, gl_Position.z, gl_Position.w);
				gl_Position = float4(gl_Position.x, gl_Position.y, vertex_unnamed_67.zw.x, vertex_unnamed_67.zw.y);
				vertex_unnamed_40 = (float2(_MaskSoftnessX, _MaskSoftnessY) * 0.25f.xx) + vertex_unnamed_67.ww;
				float2 vertex_unnamed_175 = 0.25f.xx / vertex_unnamed_40;
				vertex_output_2 = float4(vertex_output_2.x, vertex_output_2.y, vertex_unnamed_175.x, vertex_unnamed_175.y);
				vertex_output_0 = vertex_input_1 * _OutlineColor;
				vertex_output_1 = vertex_input_2;
				vertex_unnamed_67 = max(_ClipRect, (-20000000000.0f).xxxx);
				vertex_unnamed_67 = min(vertex_unnamed_67, 20000000000.0f.xxxx);
				vertex_unnamed_9 = (vertex_unnamed_9 * 2.0f.xx) + (-vertex_unnamed_67.xy);
				float2 vertex_unnamed_211 = (-vertex_unnamed_67.zw) + vertex_unnamed_9;
				vertex_output_2 = float4(vertex_unnamed_211.x, vertex_unnamed_211.y, vertex_output_2.z, vertex_output_2.w);
			}
		...
		Pass
		{
			...
			void vert_main()
			{
				precise float vertex_unnamed_50 = vertex_uniform_buffer_0[3u].x + vertex_uniform_buffer_0[3u].z;
				precise float vertex_unnamed_55 = vertex_unnamed_50 + vertex_input_0.y;
				precise float vertex_unnamed_58 = vertex_input_0.w * 0.5f;
				precise float vertex_unnamed_64 = vertex_unnamed_58 / vertex_uniform_buffer_1[6u].x;
				precise float vertex_unnamed_65 = vertex_unnamed_58 / vertex_uniform_buffer_1[6u].y;
				precise float vertex_unnamed_71 = vertex_input_0.x + vertex_uniform_buffer_0[3u].y;
				precise float vertex_unnamed_72 = vertex_unnamed_64 + vertex_unnamed_71;
				precise float vertex_unnamed_73 = vertex_unnamed_65 + vertex_unnamed_55;
				precise float vertex_unnamed_80 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].x;
				precise float vertex_unnamed_81 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].y;
				precise float vertex_unnamed_82 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].z;
				precise float vertex_unnamed_83 = vertex_unnamed_73 * vertex_uniform_buffer_2[1u].w;
			...
			void vert_main()
			{
				vertex_unnamed_9.x = _Outline + _VertexOffsetY;
				vertex_unnamed_9.y = vertex_unnamed_9.x + vertex_input_0.y;
				vertex_unnamed_40.x = vertex_input_0.w * 0.5f;
				vertex_unnamed_40 = vertex_unnamed_40.xx / _ScreenParams.xy;
				vertex_unnamed_9.x = vertex_input_0.x + _VertexOffsetX;
				vertex_unnamed_9 = vertex_unnamed_40 + vertex_unnamed_9;
				vertex_unnamed_66 = vertex_unnamed_9.yyyy * unity_ObjectToWorld__array[1];
				vertex_unnamed_66 = (unity_ObjectToWorld__array[0] * vertex_unnamed_9.xxxx) + vertex_unnamed_66;
				vertex_unnamed_66 = (unity_ObjectToWorld__array[2] * vertex_input_0.zzzz) + vertex_unnamed_66;
				...
				vertex_unnamed_93 = (unity_MatrixVP__array[2] * vertex_unnamed_66.zzzz) + vertex_unnamed_93;
				vertex_unnamed_66 = (unity_MatrixVP__array[3] * vertex_unnamed_66.wwww) + vertex_unnamed_93;
				vertex_unnamed_40 = vertex_unnamed_66.xy / vertex_unnamed_66.ww;
				float2 vertex_unnamed_129 = _ScreenParams.xy * 0.5f.xx;
				vertex_unnamed_66 = float4(vertex_unnamed_129.x, vertex_unnamed_129.y, vertex_unnamed_66.z, vertex_unnamed_66.w);
				vertex_unnamed_40 *= vertex_unnamed_66.xy;
				vertex_unnamed_40 = round(vertex_unnamed_40);
				vertex_unnamed_40 /= vertex_unnamed_66.xy;
				float2 vertex_unnamed_149 = vertex_unnamed_66.ww * vertex_unnamed_40;
				gl_Position = float4(vertex_unnamed_149.x, vertex_unnamed_149.y, gl_Position.z, gl_Position.w);
				gl_Position = float4(gl_Position.x, gl_Position.y, vertex_unnamed_66.zw.x, vertex_unnamed_66.zw.y);
				vertex_unnamed_40 = (float2(_MaskSoftnessX, _MaskSoftnessY) * 0.25f.xx) + vertex_unnamed_66.ww;
				float2 vertex_unnamed_174 = 0.25f.xx / vertex_unnamed_40;
				vertex_output_2 = float4(vertex_output_2.x, vertex_output_2.y, vertex_unnamed_174.x, vertex_unnamed_174.y);
				vertex_output_0 = vertex_input_1 * _OutlineColor;
				vertex_output_1 = vertex_input_2;
				vertex_unnamed_66 = max(_ClipRect, (-20000000000.0f).xxxx);
		...
		Pass
		{
			...
			{
				precise float vertex_unnamed_47 = (-0.0f) - vertex_uniform_buffer_0[3u].x;
				precise float vertex_unnamed_52 = vertex_unnamed_47 + vertex_uniform_buffer_0[3u].z;
				precise float vertex_unnamed_57 = vertex_unnamed_52 + vertex_input_0.y;
				precise float vertex_unnamed_60 = vertex_input_0.w * 0.5f;
				precise float vertex_unnamed_66 = vertex_unnamed_60 / vertex_uniform_buffer_1[6u].x;
				precise float vertex_unnamed_67 = vertex_unnamed_60 / vertex_uniform_buffer_1[6u].y;
				precise float vertex_unnamed_73 = vertex_input_0.x + vertex_uniform_buffer_0[3u].y;
				precise float vertex_unnamed_74 = vertex_unnamed_66 + vertex_unnamed_73;
				precise float vertex_unnamed_75 = vertex_unnamed_67 + vertex_unnamed_57;
				precise float vertex_unnamed_82 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].x;
				precise float vertex_unnamed_83 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].y;
				precise float vertex_unnamed_84 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].z;
				precise float vertex_unnamed_85 = vertex_unnamed_75 * vertex_uniform_buffer_2[1u].w;
			...
			static float2 vertex_unnamed_9;
			static float2 vertex_unnamed_41;
			static float4 vertex_unnamed_67;
			static float4 vertex_unnamed_94;
			...
			void vert_main()
			{
				vertex_unnamed_9.x = (-_Outline) + _VertexOffsetY;
				vertex_unnamed_9.y = vertex_unnamed_9.x + vertex_input_0.y;
				vertex_unnamed_41.x = vertex_input_0.w * 0.5f;
				vertex_unnamed_41 = vertex_unnamed_41.xx / _ScreenParams.xy;
				vertex_unnamed_9.x = vertex_input_0.x + _VertexOffsetX;
				vertex_unnamed_9 = vertex_unnamed_41 + vertex_unnamed_9;
				vertex_unnamed_67 = vertex_unnamed_9.yyyy * unity_ObjectToWorld__array[1];
				vertex_unnamed_67 = (unity_ObjectToWorld__array[0] * vertex_unnamed_9.xxxx) + vertex_unnamed_67;
				vertex_unnamed_67 = (unity_ObjectToWorld__array[2] * vertex_input_0.zzzz) + vertex_unnamed_67;
				vertex_unnamed_67 += unity_ObjectToWorld__array[3];
				...
				vertex_unnamed_94 = (unity_MatrixVP__array[2] * vertex_unnamed_67.zzzz) + vertex_unnamed_94;
				vertex_unnamed_67 = (unity_MatrixVP__array[3] * vertex_unnamed_67.wwww) + vertex_unnamed_94;
				vertex_unnamed_41 = vertex_unnamed_67.xy / vertex_unnamed_67.ww;
				float2 vertex_unnamed_130 = _ScreenParams.xy * 0.5f.xx;
				vertex_unnamed_67 = float4(vertex_unnamed_130.x, vertex_unnamed_130.y, vertex_unnamed_67.z, vertex_unnamed_67.w);
				vertex_unnamed_41 *= vertex_unnamed_67.xy;
				vertex_unnamed_41 = round(vertex_unnamed_41);
				vertex_unnamed_41 /= vertex_unnamed_67.xy;
				float2 vertex_unnamed_150 = vertex_unnamed_67.ww * vertex_unnamed_41;
				gl_Position = float4(vertex_unnamed_150.x, vertex_unnamed_150.y, gl_Position.z, gl_Position.w);
				gl_Position = float4(gl_Position.x, gl_Position.y, vertex_unnamed_67.zw.x, vertex_unnamed_67.zw.y);
				vertex_unnamed_41 = (float2(_MaskSoftnessX, _MaskSoftnessY) * 0.25f.xx) + vertex_unnamed_67.ww;
				float2 vertex_unnamed_175 = 0.25f.xx / vertex_unnamed_41;
				vertex_output_2 = float4(vertex_output_2.x, vertex_output_2.y, vertex_unnamed_175.x, vertex_unnamed_175.y);
				vertex_output_0 = vertex_input_1 * _OutlineColor;
				vertex_output_1 = vertex_input_2;
				vertex_unnamed_67 = max(_ClipRect, (-20000000000.0f).xxxx);
