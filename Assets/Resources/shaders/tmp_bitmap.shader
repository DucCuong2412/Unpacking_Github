Shader "TextMeshPro/Bitmap"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			void frag_main()
			{
				fragment_unnamed_9 = _FaceTex.Sample(sampler_FaceTex, fragment_input_2).xyz;
				float3 fragment_unnamed_34 = fragment_unnamed_9 * fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_34.x, fragment_unnamed_34.y, fragment_unnamed_34.z, fragment_output_0.w);
				fragment_unnamed_9.x = _MainTex.Sample(sampler_MainTex, fragment_input_1).w;
				fragment_output_0.w = fragment_unnamed_9.x * fragment_input_0.w;
			}
			...
			{
				fragment_unnamed_9.x = _MainTex.Sample(sampler_MainTex, fragment_input_1).w;
				fragment_unnamed_32 = (fragment_input_0.w * fragment_unnamed_9.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_9.x *= fragment_input_0.w;
				fragment_output_0.w = fragment_unnamed_9.x;
				fragment_unnamed_57 = fragment_unnamed_32 < 0.0f;
				if ((int(fragment_unnamed_57) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_9 = _FaceTex.Sample(sampler_FaceTex, fragment_input_2).xyz;
				float3 fragment_unnamed_84 = fragment_unnamed_9 * fragment_input_0.xyz;
				fragment_output_0 = float4(fragment_unnamed_84.x, fragment_unnamed_84.y, fragment_unnamed_84.z, fragment_output_0.w);
			}
			...
			void frag_main()
			{
				...
				fragment_unnamed_55 = _FaceTex.Sample(sampler_FaceTex, fragment_input_2).xyz;
				float3 fragment_unnamed_77 = fragment_unnamed_55 * fragment_input_0.xyz;
				fragment_unnamed_72 = float4(fragment_unnamed_77.x, fragment_unnamed_77.y, fragment_unnamed_77.z, fragment_unnamed_72.w);
				fragment_unnamed_55.x = _MainTex.Sample(sampler_MainTex, fragment_input_1).w;
				fragment_unnamed_72.w = fragment_unnamed_55.x * fragment_input_0.w;
				fragment_output_0 = fragment_unnamed_9.xxxx * fragment_unnamed_72;
			}
			...
			static bool fragment_unnamed_103;
			...
			void frag_main()
			{
				...
				float2 fragment_unnamed_35 = fragment_unnamed_9.xy + (-abs(fragment_input_3.xy));
				fragment_unnamed_9 = float4(fragment_unnamed_35.x, fragment_unnamed_35.y, fragment_unnamed_9.z, fragment_unnamed_9.w);
				float2 fragment_unnamed_42 = fragment_unnamed_9.xy * fragment_input_3.zw;
				...
				fragment_unnamed_9.x = fragment_unnamed_9.y * fragment_unnamed_9.x;
				fragment_unnamed_66.x = _MainTex.Sample(sampler_MainTex, fragment_input_1).w;
				fragment_unnamed_84.w = fragment_unnamed_66.x * fragment_input_0.w;
				fragment_unnamed_66.x = (fragment_unnamed_84.w * fragment_unnamed_9.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_103 = fragment_unnamed_66.x < 0.0f;
				if ((int(fragment_unnamed_103) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_66 = _FaceTex.Sample(sampler_FaceTex, fragment_input_2).xyz;
				float3 fragment_unnamed_128 = fragment_unnamed_66 * fragment_input_0.xyz;
				fragment_unnamed_84 = float4(fragment_unnamed_128.x, fragment_unnamed_128.y, fragment_unnamed_128.z, fragment_unnamed_84.w);
				fragment_unnamed_9 = fragment_unnamed_9.xxxx * fragment_unnamed_84;
			...
			void frag_main()
			{
				float4 fragment_unnamed_40 = _FaceTex.Sample(sampler_FaceTex, float2(fragment_input_2.x, fragment_input_2.y));
				precise float fragment_unnamed_52 = fragment_unnamed_40.x * fragment_input_1.x;
				precise float fragment_unnamed_53 = fragment_unnamed_40.y * fragment_input_1.y;
				precise float fragment_unnamed_54 = fragment_unnamed_40.z * fragment_input_1.z;
				fragment_output_0.x = fragment_unnamed_52;
				fragment_output_0.y = fragment_unnamed_53;
				fragment_output_0.z = fragment_unnamed_54;
				precise float fragment_unnamed_70 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
			...
			void discard_cond(bool fragment_unnamed_84)
			{
				if (fragment_unnamed_84)
				{
					discard_state = true;
				}
			}
			...
			void frag_main()
			{
				...
				float fragment_unnamed_42 = fragment_unnamed_40.w;
				precise float fragment_unnamed_51 = fragment_unnamed_42 * fragment_input_1.w;
				fragment_output_0.w = fragment_unnamed_51;
				discard_cond(mad(fragment_input_1.w, fragment_unnamed_42, -0.001000000047497451305389404296875f) < 0.0f);
				float4 fragment_unnamed_64 = _FaceTex.Sample(sampler_FaceTex, float2(fragment_input_2.x, fragment_input_2.y));
				precise float fragment_unnamed_76 = fragment_unnamed_64.x * fragment_input_1.x;
				precise float fragment_unnamed_77 = fragment_unnamed_64.y * fragment_input_1.y;
				precise float fragment_unnamed_78 = fragment_unnamed_64.z * fragment_input_1.z;
			...
			void frag_main()
			{
				precise float fragment_unnamed_41 = (-0.0f) - fragment_uniform_buffer_0[5u].x;
				precise float fragment_unnamed_44 = (-0.0f) - fragment_uniform_buffer_0[5u].y;
				precise float fragment_unnamed_49 = fragment_unnamed_41 + fragment_uniform_buffer_0[5u].z;
				precise float fragment_unnamed_50 = fragment_unnamed_44 + fragment_uniform_buffer_0[5u].w;
				precise float fragment_unnamed_56 = (-0.0f) - abs(fragment_input_3.x);
				precise float fragment_unnamed_61 = (-0.0f) - abs(fragment_input_3.y);
				precise float fragment_unnamed_62 = fragment_unnamed_49 + fragment_unnamed_56;
				precise float fragment_unnamed_63 = fragment_unnamed_50 + fragment_unnamed_61;
				precise float fragment_unnamed_70 = fragment_unnamed_62 * fragment_input_3.z;
				precise float fragment_unnamed_71 = fragment_unnamed_63 * fragment_input_3.w;
				precise float fragment_unnamed_76 = clamp(fragment_unnamed_71, 0.0f, 1.0f) * clamp(fragment_unnamed_70, 0.0f, 1.0f);
				float4 fragment_unnamed_83 = _FaceTex.Sample(sampler_FaceTex, float2(fragment_input_2.x, fragment_input_2.y));
				precise float fragment_unnamed_94 = fragment_unnamed_83.x * fragment_input_1.x;
				precise float fragment_unnamed_95 = fragment_unnamed_83.y * fragment_input_1.y;
				precise float fragment_unnamed_96 = fragment_unnamed_83.z * fragment_input_1.z;
				precise float fragment_unnamed_107 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				precise float fragment_unnamed_108 = fragment_unnamed_76 * fragment_unnamed_94;
				precise float fragment_unnamed_109 = fragment_unnamed_76 * fragment_unnamed_95;
				precise float fragment_unnamed_110 = fragment_unnamed_76 * fragment_unnamed_96;
				precise float fragment_unnamed_111 = fragment_unnamed_76 * fragment_unnamed_107;
				fragment_output_0.x = fragment_unnamed_108;
				fragment_output_0.y = fragment_unnamed_109;
				fragment_output_0.z = fragment_unnamed_110;
				fragment_output_0.w = fragment_unnamed_111;
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_71 = fragment_unnamed_63 * fragment_input_3.w;
				precise float fragment_unnamed_76 = clamp(fragment_unnamed_71, 0.0f, 1.0f) * clamp(fragment_unnamed_70, 0.0f, 1.0f);
				precise float fragment_unnamed_88 = _MainTex.Sample(sampler_MainTex, float2(fragment_input_2.x, fragment_input_2.y)).w * fragment_input_1.w;
				discard_cond(mad(fragment_unnamed_88, fragment_unnamed_76, -0.001000000047497451305389404296875f) < 0.0f);
				float4 fragment_unnamed_101 = _FaceTex.Sample(sampler_FaceTex, float2(fragment_input_2.x, fragment_input_2.y));
				precise float fragment_unnamed_112 = fragment_unnamed_101.x * fragment_input_1.x;
				precise float fragment_unnamed_113 = fragment_unnamed_101.y * fragment_input_1.y;
				precise float fragment_unnamed_114 = fragment_unnamed_101.z * fragment_input_1.z;
				precise float fragment_unnamed_115 = fragment_unnamed_76 * fragment_unnamed_112;
				precise float fragment_unnamed_116 = fragment_unnamed_76 * fragment_unnamed_113;
				precise float fragment_unnamed_117 = fragment_unnamed_76 * fragment_unnamed_114;
				precise float fragment_unnamed_118 = fragment_unnamed_76 * fragment_unnamed_88;
				fragment_output_0.x = fragment_unnamed_115;
				fragment_output_0.y = fragment_unnamed_116;
				fragment_output_0.z = fragment_unnamed_117;
