Shader "TextMeshPro/Mobile/Distance Field - Masking"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			static float3 fragment_unnamed_26;
			static float4 fragment_unnamed_106;
			static float3 fragment_unnamed_114;

			void frag_main()
			{
				fragment_unnamed_8 = float(_MaskInverse != 0);
				fragment_unnamed_26.x = _MaskTex.Sample(sampler_MaskTex, fragment_input_1.zw).w;
				fragment_unnamed_8 = (-fragment_unnamed_26.x) + fragment_unnamed_8;
				fragment_unnamed_26.x = (-_MaskWipeControl) + 1.0f;
				fragment_unnamed_8 = (fragment_unnamed_26.x * _MaskEdgeSoftness) + abs(fragment_unnamed_8);
				fragment_unnamed_8 += (-_MaskWipeControl);
				fragment_unnamed_8 /= _MaskEdgeSoftness;
				fragment_unnamed_8 = clamp(fragment_unnamed_8, 0.0f, 1.0f);
				fragment_unnamed_26.x = _MainTex.Sample(sampler_MainTex, fragment_input_1.xy).w;
				fragment_unnamed_26.x = (fragment_unnamed_26.x * fragment_input_2.x) + (-fragment_input_2.w);
				fragment_unnamed_26.x = clamp(fragment_unnamed_26.x, 0.0f, 1.0f);
				fragment_unnamed_106.w = fragment_unnamed_26.x * fragment_input_0.w;
				fragment_unnamed_114 = fragment_unnamed_106.www * _MaskEdgeColor.xyz;
				fragment_unnamed_26 = (fragment_input_0.xyz * fragment_unnamed_26.xxx) + (-fragment_unnamed_114);
				float3 fragment_unnamed_136 = (fragment_unnamed_8.xxx * fragment_unnamed_26) + fragment_unnamed_114;
				fragment_unnamed_106 = float4(fragment_unnamed_136.x, fragment_unnamed_136.y, fragment_unnamed_136.z, fragment_unnamed_106.w);
				fragment_output_0 = fragment_unnamed_8.xxxx * fragment_unnamed_106;
			}
			...
			static float3 fragment_unnamed_30;
			static float4 fragment_unnamed_117;
			static float3 fragment_unnamed_125;
			static float fragment_unnamed_134;
			static bool fragment_unnamed_143;

			void frag_main()
			{
				fragment_unnamed_9.x = float(_MaskInverse != 0);
				fragment_unnamed_30.x = _MaskTex.Sample(sampler_MaskTex, fragment_input_1.zw).w;
				fragment_unnamed_9.x = (-fragment_unnamed_30.x) + fragment_unnamed_9.x;
				fragment_unnamed_30.x = (-_MaskWipeControl) + 1.0f;
				fragment_unnamed_9.x = (fragment_unnamed_30.x * _MaskEdgeSoftness) + abs(fragment_unnamed_9.x);
				fragment_unnamed_9.x += (-_MaskWipeControl);
				fragment_unnamed_9.x /= _MaskEdgeSoftness;
				fragment_unnamed_9.x = clamp(fragment_unnamed_9.x, 0.0f, 1.0f);
				fragment_unnamed_30.x = _MainTex.Sample(sampler_MainTex, fragment_input_1.xy).w;
				fragment_unnamed_30.x = (fragment_unnamed_30.x * fragment_input_2.x) + (-fragment_input_2.w);
				fragment_unnamed_30.x = clamp(fragment_unnamed_30.x, 0.0f, 1.0f);
				fragment_unnamed_117.w = fragment_unnamed_30.x * fragment_input_0.w;
				fragment_unnamed_125 = fragment_unnamed_117.www * _MaskEdgeColor.xyz;
				fragment_unnamed_134 = (fragment_unnamed_117.w * fragment_unnamed_9.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_143 = fragment_unnamed_134 < 0.0f;
				if ((int(fragment_unnamed_143) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_30 = (fragment_input_0.xyz * fragment_unnamed_30.xxx) + (-fragment_unnamed_125);
				float3 fragment_unnamed_167 = (fragment_unnamed_9.xxx * fragment_unnamed_30) + fragment_unnamed_125;
				fragment_unnamed_117 = float4(fragment_unnamed_167.x, fragment_unnamed_167.y, fragment_unnamed_167.z, fragment_unnamed_117.w);
				fragment_unnamed_9 = fragment_unnamed_9.xxxx * fragment_unnamed_117;
			...
			static float4 fragment_unnamed_145;
			static float4 fragment_unnamed_151;
			...
			void frag_main()
			{
				...
				fragment_unnamed_8 /= _MaskEdgeSoftness;
				fragment_unnamed_8 = clamp(fragment_unnamed_8, 0.0f, 1.0f);
				float2 fragment_unnamed_88 = (-_ClipRect.xy) + _ClipRect.zw;
				fragment_unnamed_26 = float3(fragment_unnamed_88.x, fragment_unnamed_88.y, fragment_unnamed_26.z);
				float2 fragment_unnamed_98 = fragment_unnamed_26.xy + (-abs(fragment_input_3.xy));
				fragment_unnamed_26 = float3(fragment_unnamed_98.x, fragment_unnamed_98.y, fragment_unnamed_26.z);
				float2 fragment_unnamed_105 = fragment_unnamed_26.xy * fragment_input_3.zw;
				fragment_unnamed_26 = float3(fragment_unnamed_105.x, fragment_unnamed_105.y, fragment_unnamed_26.z);
				float2 fragment_unnamed_112 = clamp(fragment_unnamed_26.xy, 0.0f.xx, 1.0f.xx);
				fragment_unnamed_26 = float3(fragment_unnamed_112.x, fragment_unnamed_112.y, fragment_unnamed_26.z);
				fragment_unnamed_26.x = fragment_unnamed_26.y * fragment_unnamed_26.x;
				fragment_unnamed_122 = _MainTex.Sample(sampler_MainTex, fragment_input_1.xy).w;
				fragment_unnamed_122 = (fragment_unnamed_122 * fragment_input_2.x) + (-fragment_input_2.w);
				fragment_unnamed_122 = clamp(fragment_unnamed_122, 0.0f, 1.0f);
				fragment_unnamed_145 = fragment_unnamed_122.xxxx * fragment_input_0;
				fragment_unnamed_151.w = fragment_unnamed_26.x * fragment_unnamed_145.w;
				fragment_unnamed_158 = fragment_unnamed_151.www * _MaskEdgeColor.xyz;
				fragment_unnamed_26 = (fragment_unnamed_145.xyz * fragment_unnamed_26.xxx) + (-fragment_unnamed_158);
				float3 fragment_unnamed_179 = (fragment_unnamed_8.xxx * fragment_unnamed_26) + fragment_unnamed_158;
				fragment_unnamed_151 = float4(fragment_unnamed_179.x, fragment_unnamed_179.y, fragment_unnamed_179.z, fragment_unnamed_151.w);
				fragment_output_0 = fragment_unnamed_8.xxxx * fragment_unnamed_151;
			}
			...
			static float3 fragment_unnamed_169;
			static bool fragment_unnamed_185;
			...
			void frag_main()
			{
				...
				fragment_unnamed_9.x /= _MaskEdgeSoftness;
				fragment_unnamed_9.x = clamp(fragment_unnamed_9.x, 0.0f, 1.0f);
				float2 fragment_unnamed_100 = (-_ClipRect.xy) + _ClipRect.zw;
				fragment_unnamed_30 = float3(fragment_unnamed_100.x, fragment_unnamed_100.y, fragment_unnamed_30.z);
				float2 fragment_unnamed_110 = fragment_unnamed_30.xy + (-abs(fragment_input_3.xy));
				fragment_unnamed_30 = float3(fragment_unnamed_110.x, fragment_unnamed_110.y, fragment_unnamed_30.z);
				float2 fragment_unnamed_117 = fragment_unnamed_30.xy * fragment_input_3.zw;
				fragment_unnamed_30 = float3(fragment_unnamed_117.x, fragment_unnamed_117.y, fragment_unnamed_30.z);
				float2 fragment_unnamed_124 = clamp(fragment_unnamed_30.xy, 0.0f.xx, 1.0f.xx);
				fragment_unnamed_30 = float3(fragment_unnamed_124.x, fragment_unnamed_124.y, fragment_unnamed_30.z);
				fragment_unnamed_30.x = fragment_unnamed_30.y * fragment_unnamed_30.x;
				fragment_unnamed_134 = _MainTex.Sample(sampler_MainTex, fragment_input_1.xy).w;
				fragment_unnamed_134 = (fragment_unnamed_134 * fragment_input_2.x) + (-fragment_input_2.w);
				fragment_unnamed_134 = clamp(fragment_unnamed_134, 0.0f, 1.0f);
				fragment_unnamed_156 = fragment_unnamed_134.xxxx * fragment_input_0;
				fragment_unnamed_162.w = fragment_unnamed_30.x * fragment_unnamed_156.w;
				fragment_unnamed_169 = fragment_unnamed_162.www * _MaskEdgeColor.xyz;
				fragment_unnamed_134 = (fragment_unnamed_162.w * fragment_unnamed_9.x) + (-0.001000000047497451305389404296875f);
				fragment_unnamed_185 = fragment_unnamed_134 < 0.0f;
				if ((int(fragment_unnamed_185) * (-1)) != 0)
				{
					discard;
				}
				fragment_unnamed_30 = (fragment_unnamed_156.xyz * fragment_unnamed_30.xxx) + (-fragment_unnamed_169);
				float3 fragment_unnamed_209 = (fragment_unnamed_9.xxx * fragment_unnamed_30) + fragment_unnamed_169;
				fragment_unnamed_162 = float4(fragment_unnamed_209.x, fragment_unnamed_209.y, fragment_unnamed_209.z, fragment_unnamed_162.w);
				fragment_unnamed_9 = fragment_unnamed_9.xxxx * fragment_unnamed_162;
				fragment_output_0 = fragment_unnamed_9;
			}
			...
			void frag_main()
			{
				precise float fragment_unnamed_61 = (-0.0f) - _MaskTex.Sample(sampler_MaskTex, float2(fragment_input_3.z, fragment_input_3.w)).w;
				precise float fragment_unnamed_63 = asfloat((asuint(fragment_uniform_buffer_0[31u]).x != 0u) ? 1065353216u : 0u) + fragment_unnamed_61;
				precise float fragment_unnamed_68 = (-0.0f) - fragment_uniform_buffer_0[29u].y;
				precise float fragment_unnamed_69 = fragment_unnamed_68 + 1.0f;
				precise float fragment_unnamed_80 = (-0.0f) - fragment_uniform_buffer_0[29u].y;
				precise float fragment_unnamed_81 = mad(fragment_unnamed_69, fragment_uniform_buffer_0[29u].z, abs(fragment_unnamed_63)) + fragment_unnamed_80;
				precise float fragment_unnamed_85 = fragment_unnamed_81 / fragment_uniform_buffer_0[29u].z;
				float fragment_unnamed_86 = clamp(fragment_unnamed_85, 0.0f, 1.0f);
				precise float fragment_unnamed_100 = (-0.0f) - fragment_input_4.w;
				float fragment_unnamed_102 = clamp(mad(_MainTex.Sample(sampler_MainTex, float2(fragment_input_3.x, fragment_input_3.y)).w, fragment_input_4.x, fragment_unnamed_100), 0.0f, 1.0f);
				precise float fragment_unnamed_105 = fragment_unnamed_102 * fragment_input_1.w;
				precise float fragment_unnamed_112 = fragment_unnamed_105 * fragment_uniform_buffer_0[30u].x;
				precise float fragment_unnamed_113 = fragment_unnamed_105 * fragment_uniform_buffer_0[30u].y;
				precise float fragment_unnamed_114 = fragment_unnamed_105 * fragment_uniform_buffer_0[30u].z;
				precise float fragment_unnamed_121 = (-0.0f) - fragment_unnamed_112;
				precise float fragment_unnamed_122 = (-0.0f) - fragment_unnamed_113;
				precise float fragment_unnamed_123 = (-0.0f) - fragment_unnamed_114;
				precise float fragment_unnamed_130 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.x, fragment_unnamed_102, fragment_unnamed_121), fragment_unnamed_112);
				precise float fragment_unnamed_131 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.y, fragment_unnamed_102, fragment_unnamed_122), fragment_unnamed_113);
				precise float fragment_unnamed_132 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.z, fragment_unnamed_102, fragment_unnamed_123), fragment_unnamed_114);
				precise float fragment_unnamed_133 = fragment_unnamed_86 * fragment_unnamed_105;
			...
			Fragment_Stage_Output frag(Fragment_Stage_Input stage_input)
			{
				fragment_uniform_buffer_0[29] = float4(fragment_uniform_buffer_0[29][0], _MaskWipeControl, fragment_uniform_buffer_0[29][2], fragment_uniform_buffer_0[29][3]);

				fragment_uniform_buffer_0[29] = float4(fragment_uniform_buffer_0[29][0], fragment_uniform_buffer_0[29][1], _MaskEdgeSoftness, fragment_uniform_buffer_0[29][3]);

				fragment_uniform_buffer_0[30] = float4(_MaskEdgeColor[0], _MaskEdgeColor[1], _MaskEdgeColor[2], _MaskEdgeColor[3]);

				fragment_uniform_buffer_0[31] = float4(asfloat(_MaskInverse), fragment_uniform_buffer_0[31][1], fragment_uniform_buffer_0[31][2], fragment_uniform_buffer_0[31][3]);
			...
			void discard_cond(bool fragment_unnamed_147)
			{
				if (fragment_unnamed_147)
				{
					discard_state = true;
				}
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_113 = fragment_unnamed_105 * fragment_uniform_buffer_0[30u].y;
				precise float fragment_unnamed_114 = fragment_unnamed_105 * fragment_uniform_buffer_0[30u].z;
				discard_cond(mad(fragment_unnamed_105, fragment_unnamed_86, -0.001000000047497451305389404296875f) < 0.0f);
				precise float fragment_unnamed_127 = (-0.0f) - fragment_unnamed_112;
				precise float fragment_unnamed_128 = (-0.0f) - fragment_unnamed_113;
				precise float fragment_unnamed_129 = (-0.0f) - fragment_unnamed_114;
				precise float fragment_unnamed_136 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.x, fragment_unnamed_102, fragment_unnamed_127), fragment_unnamed_112);
				precise float fragment_unnamed_137 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.y, fragment_unnamed_102, fragment_unnamed_128), fragment_unnamed_113);
				precise float fragment_unnamed_138 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_input_1.z, fragment_unnamed_102, fragment_unnamed_129), fragment_unnamed_114);
				precise float fragment_unnamed_139 = fragment_unnamed_86 * fragment_unnamed_105;
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_85 = fragment_unnamed_81 / fragment_uniform_buffer_0[29u].z;
				float fragment_unnamed_86 = clamp(fragment_unnamed_85, 0.0f, 1.0f);
				precise float fragment_unnamed_91 = (-0.0f) - fragment_uniform_buffer_0[26u].x;
				precise float fragment_unnamed_93 = (-0.0f) - fragment_uniform_buffer_0[26u].y;
				precise float fragment_unnamed_98 = fragment_unnamed_91 + fragment_uniform_buffer_0[26u].z;
				precise float fragment_unnamed_99 = fragment_unnamed_93 + fragment_uniform_buffer_0[26u].w;
				precise float fragment_unnamed_103 = (-0.0f) - abs(fragment_input_5.x);
				precise float fragment_unnamed_108 = (-0.0f) - abs(fragment_input_5.y);
				precise float fragment_unnamed_109 = fragment_unnamed_98 + fragment_unnamed_103;
				precise float fragment_unnamed_110 = fragment_unnamed_99 + fragment_unnamed_108;
				precise float fragment_unnamed_115 = fragment_unnamed_109 * fragment_input_5.z;
				precise float fragment_unnamed_116 = fragment_unnamed_110 * fragment_input_5.w;
				precise float fragment_unnamed_119 = clamp(fragment_unnamed_116, 0.0f, 1.0f) * clamp(fragment_unnamed_115, 0.0f, 1.0f);
				precise float fragment_unnamed_132 = (-0.0f) - fragment_input_4.w;
				float fragment_unnamed_134 = clamp(mad(_MainTex.Sample(sampler_MainTex, float2(fragment_input_3.x, fragment_input_3.y)).w, fragment_input_4.x, fragment_unnamed_132), 0.0f, 1.0f);
				precise float fragment_unnamed_143 = fragment_unnamed_134 * fragment_input_1.x;
				precise float fragment_unnamed_144 = fragment_unnamed_134 * fragment_input_1.y;
				precise float fragment_unnamed_145 = fragment_unnamed_134 * fragment_input_1.z;
				precise float fragment_unnamed_146 = fragment_unnamed_134 * fragment_input_1.w;
				precise float fragment_unnamed_147 = fragment_unnamed_119 * fragment_unnamed_146;
				precise float fragment_unnamed_154 = fragment_unnamed_147 * fragment_uniform_buffer_0[30u].x;
				precise float fragment_unnamed_155 = fragment_unnamed_147 * fragment_uniform_buffer_0[30u].y;
				precise float fragment_unnamed_156 = fragment_unnamed_147 * fragment_uniform_buffer_0[30u].z;
				precise float fragment_unnamed_157 = (-0.0f) - fragment_unnamed_154;
				precise float fragment_unnamed_158 = (-0.0f) - fragment_unnamed_155;
				precise float fragment_unnamed_159 = (-0.0f) - fragment_unnamed_156;
				precise float fragment_unnamed_166 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_143, fragment_unnamed_119, fragment_unnamed_157), fragment_unnamed_154);
				precise float fragment_unnamed_167 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_144, fragment_unnamed_119, fragment_unnamed_158), fragment_unnamed_155);
				precise float fragment_unnamed_168 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_145, fragment_unnamed_119, fragment_unnamed_159), fragment_unnamed_156);
				precise float fragment_unnamed_169 = fragment_unnamed_86 * fragment_unnamed_147;
				fragment_output_0.x = fragment_unnamed_166;
				fragment_output_0.y = fragment_unnamed_167;
				fragment_output_0.z = fragment_unnamed_168;
				fragment_output_0.w = fragment_unnamed_169;
			}
			...
			void discard_cond(bool fragment_unnamed_183)
			{
				if (fragment_unnamed_183)
				{
					discard_state = true;
				}
			}
			...
			void frag_main()
			{
				...
				precise float fragment_unnamed_155 = fragment_unnamed_147 * fragment_uniform_buffer_0[30u].y;
				precise float fragment_unnamed_156 = fragment_unnamed_147 * fragment_uniform_buffer_0[30u].z;
				discard_cond(mad(fragment_unnamed_147, fragment_unnamed_86, -0.001000000047497451305389404296875f) < 0.0f);
				precise float fragment_unnamed_163 = (-0.0f) - fragment_unnamed_154;
				precise float fragment_unnamed_164 = (-0.0f) - fragment_unnamed_155;
				precise float fragment_unnamed_165 = (-0.0f) - fragment_unnamed_156;
				precise float fragment_unnamed_172 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_143, fragment_unnamed_119, fragment_unnamed_163), fragment_unnamed_154);
				precise float fragment_unnamed_173 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_144, fragment_unnamed_119, fragment_unnamed_164), fragment_unnamed_155);
				precise float fragment_unnamed_174 = fragment_unnamed_86 * mad(fragment_unnamed_86, mad(fragment_unnamed_145, fragment_unnamed_119, fragment_unnamed_165), fragment_unnamed_156);
				precise float fragment_unnamed_175 = fragment_unnamed_86 * fragment_unnamed_147;
